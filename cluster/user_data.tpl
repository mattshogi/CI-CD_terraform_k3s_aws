...
export NODE_INDEX SERVER_IP K3S_TOKEN ENABLE_MONITORING ENABLE_INGRESS_NGINX \
	ENABLE_TLS ENABLE_GITOPS GITOPS_REPO_URL GITOPS_REF APP_IMAGE \
	HELLO_NODE_PORT REPO_TARBALL_URL INSTALL_DOCKER GRAFANA_ADMIN_PASSWORD \
	HA_MODE CLUSTER_INIT SERVER_JOIN_URL TLS_HOST
